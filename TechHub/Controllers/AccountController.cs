        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Redirect to the home page with a notification query string
        ...
        public async Task<IActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Redirect the user to the home page with a notification query string
                    return RedirectToAction(nameof(HomeController.Index), "Home", new { notify = "register" });
                }
