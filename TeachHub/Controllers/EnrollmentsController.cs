...
namespace TeachHub.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CourseId,LearnerId")] Enrollment enrollment)
        {
            ...
            ViewData["CourseId"] = new SelectList(_context.Courses, "CourseId", "Description", enrollment.CourseId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CourseId,LearnerId")] Enrollment enrollment)
        {
            if (id != enrollment.LearnerId)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!EnrollmentExists(enrollment.LearnerId))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Enrollments.Any(e => e.LearnerId == id);
        }
    }
}
