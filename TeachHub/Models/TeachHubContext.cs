    ...
    public class TeachHubContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Enrollment>()
                .HasKey(e => new {e.LearnerId,e.CourseId});  // Primary key

            modelBuilder.Entity<Enrollment>()
                .HasOne(e => e.Course)
                .WithMany(c => c.Enrollments)
                .HasForeignKey(e => e.CourseId)
                .OnDelete(DeleteBehavior.Cascade);  // Keep cascading delete for Course
            ...
            modelBuilder.Entity<Enrollment>()
                ...
                .OnDelete(DeleteBehavior.Restrict);  // Keep cascading delete for Course
